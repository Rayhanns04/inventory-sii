...
<div class="top-bar">
    ...
    <div data-url="{{ route('dark-mode-switcher') }}"
        class="dark-mode-switcher cursor-pointer shadow-md box dark:bg-dark-2 border rounded-full w-40 h-12 flex items-center justify-center mr-3">
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit" role="button"
            aria-expanded="false">
        ...
        <div class="dropdown-menu w-56">
            <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                <div class="p-4 border-b border-theme-27 dark:border-dark-3">
                    ...
                    <div class="text-xs text-theme-28 mt-0.5 dark:text-gray-600">Admin Inventory</div>
                </div>
                {{-- <div class="p-2">
                    <a href=""
