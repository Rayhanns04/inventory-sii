...
<div class="top-bar">
    ...
    <!-- END: Notifications -->
    {{-- Dark Mode Switcher --}}
    <div data-url="{{ route('dark-mode-switcher') }}" class="dark-mode-switcher cursor-pointer shadow-md box dark:bg-dark-2 border rounded-full w-40 h-12 flex items-center justify-center mr-3">
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit" role="button" aria-expanded="false">
