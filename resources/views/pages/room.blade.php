...
@section('subcontent')
            ...
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" action="{{ $ACTION }}/save-create" method="POST">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        <div class="col-span-12"> <label for="modal-form-1" class="form-label">Room</label>
                            <input name="name" id="modal-form-1" type="text" class="form-control"
                                placeholder="inputkan Room">
                        </div>

                        <div class="col-span-12"> <label for="modal-form-6" class="form-label">Lantai</label>
                            <select id="modal-form-6" class="form-select" name="floor_id">
    ...
    @foreach ($rooms as $room)
        <div id="header-footer-modal-preview-{{ $room->id }}" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <!-- BEGIN: Modal Header -->
                    <div class="modal-header">
                    ...
                    {{-- Form --}}
                    <form enctype="multipart/form-data" action="{{ $ACTION }}/save-edit/{{ $room->id }}"
                        method="POST">
                        @csrf
                        <!-- BEGIN: Modal Body -->
                        <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            <div class="col-span-12"> <label for="modal-form-1" class="form-label">Room</label>
                                <input name="name" id="modal-form-1" type="text" class="form-control"
                                    placeholder="inputkan angka Room" value="{{ $room->name }}">
                            </div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="tooltip btn btn-primary shadow-md mr-2" title="Filter Room">
            ...
            {{-- Plus --}}
            <a href="javascript:;" class="tooltip btn btn-primary shadow-md mr-2" title="Tambah Room" data-toggle="modal"
            ...
            <div class="hidden md:block mx-auto text-gray-600">Showing {{ $rooms->firstItem() }} to
                {{ $rooms->lastItem() }} of {{ $rooms->total() }} entries
            </div>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3" href="javascript:;" data-toggle="modal"
                                        data-target="#header-footer-modal-preview-{{ $room->id }}">
                                        <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit
                                    </a>
                                    <a class="flex items-center text-theme-6" href="javascript:;" data-toggle="modal"
                                        data-target="#delete-confirmation-modal-{{ $room->id }}">
    ...
    @foreach ($rooms as $room)
        ...
        <div id="delete-confirmation-modal-{{ $room->id }}" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <div class="px-5 pb-8 text-center">
                            ...
                            <a href="{{ $ACTION }}/{{ $room->id }}" type="button"
