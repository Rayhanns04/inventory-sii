...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('/settings')->group(function () {
        Route::prefix('/floors')->group(function () {
            ...
            Route::post('/save-create', [FloorController::class, 'store']);
            Route::post('/save-edit/{id}', [FloorController::class, 'update']);
            Route::get('/{id}', [FloorController::class, 'destroy']);
        });
        Route::prefix('/conditions')->group(function () {
            Route::get('/', [ConditionController::class, 'index']);
            Route::post('/save-create', [ConditionController::class, 'store']);
            Route::post('/save-edit/{id}', [ConditionController::class, 'update']);
            Route::get('/{id}', [ConditionController::class, 'destroy']);
        });
        Route::prefix('/rooms')->group(function () {
            Route::get('/', [RoomController::class, 'index']);
            Route::post('/save-create', [RoomController::class, 'store']);
            Route::post('/save-edit/{id}', [RoomController::class, 'update']);
            Route::get('/{id}', [RoomController::class, 'destroy']);
        });
        Route::prefix('/stuffs')->group(function () {
            Route::get('/', [StuffController::class, 'index']);
            Route::post('/save-create', [StuffController::class, 'store']);
            Route::post('/save-edit/{id}', [StuffController::class, 'update']);
            Route::get('/{id}', [StuffController::class, 'destroy']);
        });
    });

    Route::prefix('/reports')->group(function () {
        Route::prefix('/floors')->group(function () {
            Route::get('/{room:id}', [ReportController::class, 'index']);
            Route::get('/{room:id}/detail/{date}', [ReportController::class, 'detail']);
            Route::post('/save-create', [ReportController::class, 'store']);
            Route::post('/save-edit/{id}', [ReportController::class, 'update']);
            Route::get('/{id}', [ReportController::class, 'destroy']);
            Route::get('/{room:id}/create-report', [ReportController::class, 'createReport']);
        });
    });
